...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '路由配置表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_route_conf` VALUES (4, '支付中心', 'whale-pay-order', '[{\"args\": {\"_genkey_0\": \"/whale-pay/**\"}, \"name\": \"Path\"}]', '[]', 'lb://whale-pay-order', 0, '2019-10-16 16:44:41', '2020-07-29 21:59:17', '0');
INSERT INTO `sys_route_conf` VALUES (5, '消息中心', 'whale-message-centre', '[{\"args\": {\"_genkey_0\": \"/whale-message/**\"}, \"name\": \"Path\"}]', '[]', 'lb://whale-message-centre', 0, '2019-10-16 16:44:41', '2020-08-09 21:27:33', '0');

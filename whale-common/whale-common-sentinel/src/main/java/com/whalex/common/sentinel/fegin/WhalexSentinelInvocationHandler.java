 ...
 */
@Slf4j
public class WhalexSentinelInvocationHandler implements InvocationHandler {
	...
	WhalexSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
				...
				try {
					...
					if (fallbackFactory != null) {
						...
						if (R.class == method.getReturnType()) {
							...
							return R.faile(ex.getLocalizedMessage());
						} else {
							throw ex;
						}
					}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			WhalexSentinelInvocationHandler other = (WhalexSentinelInvocationHandler) obj;

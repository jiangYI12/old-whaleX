...
//            List<DegradeRuleEntity> rules = sentinelApiClient.fetchDegradeRuleOfMachine(app, ip, port);
    ...
    public Result<DegradeRuleEntity> add(String app, String ip, Integer port, String limitApp, String resource,
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("degradeRule add 更新nacos配置失败",e.getMessage());
    ...
    public Result<DegradeRuleEntity> updateIfNotNull(Long id, String app, String limitApp, String resource,
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("degradeRule save 更新nacos配置失败",e.getMessage());
            return Result.ofFail(-1,e.getMessage());
        }
    ...
    public Result<Long> delete(Long id) {
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("degradeRule delete 更新nacos配置失败",e.getMessage());
            return Result.ofFail(-1,e.getMessage());
        }
